...
s01 → `s02` → [s03](../s03_edit_queue/) → [s04](../s04_interrupt/) → ... → s08
...
合上 code.ts 和本 README，打开 [practice.ts](practice.ts)，凭记忆补全：`safePath`、`runBash`、`readFile`、`writeFile`、`agentLoop`。
...
下一章：[s03 edit + 变更队列](../s03_edit_queue/)
