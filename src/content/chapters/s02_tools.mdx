...
1. [`packages/agent/src/harness/tools/bash.ts`](https://github.com/earendil-works/pi/blob/v0.75.5/packages/agent/src/harness/tools/bash.ts) — bash 工具，流式输出 + 截断
2. [`packages/agent/src/harness/tools/read.ts`](https://github.com/earendil-works/pi/blob/v0.75.5/packages/agent/src/harness/tools/read.ts) — read 工具，支持图片 + offset/limit 分页
3. [`packages/agent/src/harness/tools/write.ts`](https://github.com/earendil-works/pi/blob/v0.75.5/packages/agent/src/harness/tools/write.ts) — write 工具，自动建父目录
4. [`packages/agent/src/harness/tools/index.ts`](https://github.com/earendil-works/pi/blob/v0.75.5/packages/agent/src/harness/tools/index.ts) — 注册表汇总导出
