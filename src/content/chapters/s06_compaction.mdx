...
mini-pi 的压缩是教学级简化。真 pi 的实现分布在 [`packages/agent/src/harness/compaction/`](https://github.com/earendil-works/pi/tree/v0.75.5/packages/agent/src/harness/compaction/)，先读 [`compaction.ts`](https://github.com/earendil-works/pi/blob/v0.75.5/packages/agent/src/harness/compaction/compaction.ts)，回答三个问题（答案就在代码里）：
