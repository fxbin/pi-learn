...
mini-pi 的十几行循环，在真 pi 里对应 `runLoop`：[`packages/agent/src/agent-loop.ts`](https://github.com/earendil-works/pi/blob/v0.75.5/packages/agent/src/agent-loop.ts) 第 155-275 行。先读一遍，再回答三个问题（答案就在代码里）：
