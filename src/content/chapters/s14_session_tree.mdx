...
**第一处：[`packages/coding-agent/src/core/session-manager.ts`](https://github.com/earendil-works/pi/blob/v0.75.5/packages/coding-agent/src/core/session-manager.ts)**
...
**第二处：[`packages/agent/src/harness/session/jsonl-storage.ts`](https://github.com/earendil-works/pi/blob/v0.75.5/packages/agent/src/harness/session/jsonl-storage.ts)**
...
**第三处：[`packages/coding-agent/src/core/agent-session.ts`](https://github.com/earendil-works/pi/blob/v0.75.5/packages/coding-agent/src/core/agent-session.ts) 的 `navigateTree`（约 2657 行）**
