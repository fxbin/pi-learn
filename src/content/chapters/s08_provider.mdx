...
**第一处：[`packages/ai/src/api/transform-messages.ts`](https://github.com/earendil-works/pi/blob/v0.75.5/packages/ai/src/api/transform-messages.ts)**
...
**第二处：[`packages/ai/src/providers/deepseek.ts`](https://github.com/earendil-works/pi/blob/v0.75.5/packages/ai/src/providers/deepseek.ts)**
