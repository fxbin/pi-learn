...
s01 → s02 → `s03` → [s04](../s04_interrupt/) → ... → s08
...
合上 code.ts 和本 README，打开 [practice.ts](practice.ts)，凭记忆补全：`enqueueMutation`、`writeTool`、`editTool`、`agentLoop`。
...
下一章：[s04 中断与 steering](../s04_interrupt/)
