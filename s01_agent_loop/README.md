...
合上 code.ts 和本 README，打开 [practice.ts](practice.ts)，凭记忆补全四个函数体：`callLlm`、`runBash`、`agentLoop`、`main`。
...
下一章：[s02 bash/read/write — 三个"无聊"工具与 dispatch 表](../s02_tools/)
